...
4. Update Java package names, `Constants`, entry points, mixin config names, and language assets from `ae2randomsorting` to your mod id.
...
public final class ModConfigs {
    ...
    public static final ConfigDeclaration CLIENT =
            ConfigDeclaration.of(ConfigSide.CLIENT, ClientConfig.ENTRIES, "ae2randomsorting-client-special.toml");
